...
BitLocker should just like on any specific physical machine within its hardware limitations as long as that environment (physical or virtual) meets Windows OS requirements to run.
